...
import com.ox.scaletablayout.frame.OnTabSelectChangeListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stl.setOnTabSelectChangeListener(new OnTabSelectChangeListener() {
            ...
            @Override
            public void onTabUnSelected(int id, View view) {
                Toast.makeText(MainActivity.this, "un select tab id = " + id, Toast.LENGTH_SHORT).show();
            }
        });
